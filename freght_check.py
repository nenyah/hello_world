...
if __name__ == '__main__':
    ...
    file = r'2017-3月信儒电子汇总帐单20170327.xls'
    full_path = os.path.join(path,file)
    erp_path = r"E:\Work\06-Work\00-Todo\Self Calc\Freight Self Calc Download\order_detail_export_2017-3-27.xlsx"
