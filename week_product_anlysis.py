...
product = r"E:\Work\06-Work\Data Anlysis\03-商品数据\Product+Analysis 2017513.xls"
promotion = r"E:\Work\06-Work\Data Anlysis\03-商品数据\商品推广20170513.xls"
...
anlysis = anlysis.loc[:, output_col]
date = anlysis['日期'][0]
anlysis.to_csv(
    r'E:\Work\06-Work\Data Anlysis\03-商品数据\产品分析_{0}.csv'.format(date), index=False)
